...
4. To extract data from the specification via command-line call and move the output into a text file:<br/>"__java -jar [en16931-data-extractor-20190823-jar-with-dependencies.jar](docs/en16931-data-extractor-20190823-jar-with-dependencies.jar) specification.odt (or directory)  > log.txt__"
