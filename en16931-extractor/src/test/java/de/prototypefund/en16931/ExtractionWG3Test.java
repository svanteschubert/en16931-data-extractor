...
public class ExtractionWG3Test {
    ...
    public void collectSpecData() throws Exception {
        try {
            new OdtTableDataExtraction().collectSpecData(ODT_RESOURCE);
        } catch (Exception t) {
            LoggerFactory.getLogger(ExtractionWG3Test.class.getName()).error("ERROR: " + t.getMessage(), t);
        }
    }
}
