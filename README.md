...
## Usage
### Extracting the Data
1. Download the JAR with all dependencies includes [en16931-data-extractor-20190822-jar-with-dependencies.jar](docs/en16931-data-extractor-20190822-jar-with-dependencies.jar)
2. To see version information via command-line call:<br/>"__java -jar [en16931-data-extractor-20190822-jar-with-dependencies.jar](docs/en16931-data-extractor-20190822-jar-with-dependencies.jar)__"
...
4. To extract data from the specification via command-line call:<br/>"__java -jar [en16931-data-extractor-20190822-jar-with-dependencies.jar](docs/en16931-data-extractor-20190822-jar-with-dependencies.jar) your-specification.odt (or your-directory)__"
