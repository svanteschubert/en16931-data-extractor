...
4. To extract data from the specification via command-line call:<br/>"__java -jar [en16931-data-extractor-20190823-jar-with-dependencies.jar](docs/en16931-data-extractor-20190823-jar-with-dependencies.jar) your-specification.odt (or your-directory)__"
