 ...
 * <p>
 * OdfTableRow provides methods to get table cells that belong to this table
 * row.
 *
 */
public class OdfTableRow {
    ...
    /**
     * Get the <code>OdfTableRow</code> instance from the
     * <code>TableTableRowElement</code> instance.
     * <p>
     * Each <code>TableTableRowElement</code> instance has a one-to-one
     * relationship to a <code>OdfTableRow</code> instance.
     *
     * @param rowElement	the row element that need to get the corresponding
     * <code>OdfTableRow</code> instance
     * @return the <code>OdfTableRow</code> instance represent the specified row
     * element
     */
     ...
     * second parameter.
     *
     * @param height the height/minimal height that will be set to the row (in
     * Millimeter).
     * @param isMinHeight if it is true, the row can fit the height to the text,
     * vice versa.
     */
     ...
     *
     * @param isUseOptimalHeight the flag that indicate row should keep its
     * optimal height or not
     */
    ...
    public int getCellCount() {
        NodeList childNodes = maRowElement.getChildNodes();
        int cellCount = 0;
        for (int i = 0; i < childNodes.getLength(); i++) {
            Node n = childNodes.item(i);
            if (n instanceof TableTableCellElement) {
                cellCount += ((TableTableCellElement) n).getRepetition();
            }
        }
        return cellCount;
//		OdfTable table = getTable();
