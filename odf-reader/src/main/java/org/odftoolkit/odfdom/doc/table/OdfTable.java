...
public class OdfTable {
     ...
     * @return an instance of <code>OdfTable</code> that can represent
     ...
     * <p>
     * An UnsupportedOperationException will be thrown if the table is in the
...
//	}
    /**
     * Construct the <code>OdfTable</code> feature. The default column count is
     * 5. The default row count is 2.
     * <p>
     * The table will be inserted at the end of the document the parent element
     * belongs to. An unique table name will be given, you may set a custom
     * table name using the <code>setTableName</code> method.
     * <p>
     ...
     * 5. The default row count is 2.
     * <p>
     * The table will be inserted at the end of the given document. An unique
    ...
    /**
     * Construct the <code>OdfTable</code> feature with a specified row number
     * and column number.
     * <p>
     ...
     * <p>
     * An unique table name will be given, you may set a custom table name using
     * the <code>setTableName</code> method.
     * <p>
     * If the document is a text document, cell borders will be created by
     * default.
     *
    ...
    /**
     * Construct the OdfTable feature with a specified 2 dimension array as the
     ...
     * @param rowLabel	set as the header row, it can be null if no header row
     * needed
     * @param columnLabel	set as the header column, it can be null if no header
     * column needed
    ...
    public OdfTableColumn appendColumn() {
        ...
        {
            OdfStyle columnStyle = mTableElement.getOrCreateAutomaticStyles().newStyle(OdfStyleFamily.TableColumn);
            String columnStylename = columnStyle.getStyleNameAttribute();
     ...
     * @throws IllegalArgumentException if the tableName is duplicate with one
     * of tables in the current document
     */
     ...
     * style settings. So inheritance setting have no effect on them.
     *
     * @param isEnabled if<code>isEnabled</code> is true, cell style will be
     * inherited by new cell.
     *
