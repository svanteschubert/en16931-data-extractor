 ...
 * versioning methods from command line: "java -jar odfdom-<VERSION_INFO>.jar".
 */
public class JarManifest {
    ...
    /** The problem is that in the test environment the class is NOT within the JAR, but in a class diretory where no MANIFEST.MF exists..*/
