...
public class StyleStyleElement extends OdfStyleBase {
    ...
    /**
     * Receives the value of the ODFDOM attribute representation
     * <code>StyleClassAttribute</code> , See {
     *
    ...
    /**
     * Receives the value of the ODFDOM attribute representation
     * <code>StyleDataStyleNameAttribute</code> , See {
     *
    ...
    /**
     * Receives the value of the ODFDOM attribute representation
     * <code>StyleDefaultOutlineLevelAttribute</code> , See {
     *
    ...
    /**
     * Receives the value of the ODFDOM attribute representation
     * <code>StyleDisplayNameAttribute</code> , See {
     *
    ...
    /**
     * Receives the value of the ODFDOM attribute representation
     * <code>StyleFamilyAttribute</code> , See {
     *
    ...
    /**
     * Receives the value of the ODFDOM attribute representation
     * <code>StyleListLevelAttribute</code> , See {
     *
    ...
    /**
     * Receives the value of the ODFDOM attribute representation
     * <code>StyleListStyleNameAttribute</code> , See {
     *
    ...
    /**
     * Receives the value of the ODFDOM attribute representation
     * <code>StyleMasterPageNameAttribute</code> , See {
     *
    ...
    /**
     * Receives the value of the ODFDOM attribute representation
     * <code>StyleNameAttribute</code> , See {
     *
    ...
    public void setStyleNameAttribute(String styleNameValue) {
        ...
        if (mErrorHandler != null) {
            ...
            if (!StyleNameRef.isValid(styleNameValue)) {
                try {
                    mErrorHandler.error(new OdfValidationException(OdfSchemaConstraint.DOCUMENT_XML_INVALID_ATTRIBUTE_VALUE, styleNameValue, "style:name"));
    ...
    /**
     * Receives the value of the ODFDOM attribute representation
     * <code>StyleNextStyleNameAttribute</code> , See {
     *
    ...
    public void setStyleNextStyleNameAttribute(String styleNextStyleNameValue) {
        ...
        if (mErrorHandler != null) {
            ...
            if (!StyleNameRef.isValid(styleNextStyleNameValue)) {
                try {
                    mErrorHandler.error(new OdfValidationException(OdfSchemaConstraint.DOCUMENT_XML_INVALID_ATTRIBUTE_VALUE, styleNextStyleNameValue, "style:next-style-name"));
                } catch (SAXException ex) {
                    Logger.getLogger(StyleStyleElement.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
    ...
    /**
     * Receives the value of the ODFDOM attribute representation
     * <code>StyleParentStyleNameAttribute</code> , See {
     *
    ...
    public void setStyleParentStyleNameAttribute(String styleParentStyleNameValue) {
        ...
        if (mErrorHandler != null) {
            ...
            if (!StyleName.isValid(styleParentStyleNameValue)) {
                try {
                    mErrorHandler.error(new OdfValidationException(OdfSchemaConstraint.DOCUMENT_XML_INVALID_ATTRIBUTE_VALUE, styleParentStyleNameValue, "style:parent-style-name"));
                } catch (SAXException ex) {
                    Logger.getLogger(StyleStyleElement.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
    ...
    /**
     * Receives the value of the ODFDOM attribute representation
     * <code>StylePercentageDataStyleNameAttribute</code> , See {
     *
     ...
     *
     * @param chartSymbolTypeValue the <code>String</code> value of
     * <code>ChartSymbolTypeAttribute</code>, see {
     ...
     *
     * @param styleApplyStyleNameValue the <code>String</code> value of
     * <code>StyleApplyStyleNameAttribute</code>, see {
     * @odf.attribute style:apply-style-name} at specification
     * @param styleConditionValue the <code>String</code> value of
     * <code>StyleConditionAttribute</code>, see {
     ...
     *
     * @param textDisplayValue the <code>String</code> value of
     * <code>TextDisplayAttribute</code>, see {
