...
public class TableTableRowElement extends OdfStylableElement {
	 ...
	 * <code>TableDefaultCellStyleNameAttribute</code> , See {
	 *
	...
	/**
	 * Receives the value of the ODFDOM attribute representation
	 * <code>TableNumberRowsRepeatedAttribute</code> , See {
	 *
	...
	/**
	 * Receives the value of the ODFDOM attribute representation
	 * <code>TableStyleNameAttribute</code> , See {
	 *
	...
	/**
	 * Receives the value of the ODFDOM attribute representation
	 * <code>TableVisibilityAttribute</code> , See {
	 *
	 ...
	 *
	 * @param officeValueValue the <code>Double</code> value *
	 * of <code>OfficeValueAttribute</code>, see {
	 * @odf.attribute office:value} at specification
	 * @param officeValueTypeValue the <code>String</code> value *
	 * of <code>OfficeValueTypeAttribute</code>, see {
